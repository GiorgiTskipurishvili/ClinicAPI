...
namespace ClinicAPI.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        //[HttpPost]
        //public IActionResult AddUser([FromForm] UserDTOs userDTOs)
        //{
        //    if (userDTOs.Role != Role.User)
        //    {
        //        return BadRequest($"Error Role: This is not {userDTOs.Role} Role! The role must be set to {Role.User}");
        //    }
        ...
        //    if (userDTOs.Role != Role.User)
        //    {
        //        return BadRequest(new { message = "Invalid role. Only users can be registered." });
        //    }

        //    try
        //    {
        //        PKG_USERS pkgUsers = new PKG_USERS();
        //        pkgUsers.add_user(userDTOs);
        ...
        //public IActionResult AddUser([FromForm] UserDTOs userDTOs)
        //{
        //    _logger.LogInformation("Received User Data: {@User}", userDTOs);
        ...
        //[HttpPost]
        //public IActionResult AddUser(UserDTOs userDTOs)
        //{


        //    if (userDTOs.Role != 2)
        //    {
        //        return BadRequest($"Error Role: This is not {userDTOs.Role} Role! The role must be set to {Role.User} 2");
        //    }
